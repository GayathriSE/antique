  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 border border-amber-100">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent text-stone-800 placeholder-stone-400"
          />
          {errors.email && (
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 border border-stone-300 rounded-lg py-2.5 hover:bg-stone-50 transition-colors disabled:opacity-60"
      >
